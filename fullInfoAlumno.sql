...
SET @Nombre		= '%octavio%';
SET @Apellido	= '%quequesana%';
01127477
/*******************************************/

--select top 100 * from clientes where	CLTE_Nombre	like @Nombre and CLTE_Apellido like @Apellido order by CLTE_Apellido, CLTE_Nombre
